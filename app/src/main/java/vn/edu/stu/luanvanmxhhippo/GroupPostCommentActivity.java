...
import vn.edu.stu.Adapter.GroupPostCommentAdapter;
...
public class GroupPostCommentActivity extends AppCompatActivity {
    ...
    private void addComment() {
        ...
        String commentid = reference.child(groupPostId)
    ...
    private void addControls() {
        ...
        commentAdapter = new GroupPostCommentAdapter(this, commentList, postid, groupPostId);
