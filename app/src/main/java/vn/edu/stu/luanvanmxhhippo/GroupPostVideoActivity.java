...
public class GroupPostVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_post_video);
    ...
    private void showSelectedGroup() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<GroupChatList> adapter = new ArrayAdapter<>(GroupPostVideoActivity.this, android.R.layout.simple_list_item_1, groupChatLists);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        alertDialog.dismiss();
                        Toast.makeText(GroupPostVideoActivity.this, groupChatLists.get(position).getGroudchatlist_grouptitle(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void addControls() {
        ...
        progressDialog = new ProgressDialog(GroupPostVideoActivity.this);
    }
}