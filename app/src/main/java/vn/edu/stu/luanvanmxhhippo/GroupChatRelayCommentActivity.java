...
import vn.edu.stu.Adapter.GroupPostRelayCommentAdapter;
...
public class GroupChatRelayCommentActivity extends AppCompatActivity {

    private RecyclerView recycler_view_reply_comments;
    private GroupPostRelayCommentAdapter replyCommentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_chat_relay_comment);
        ...
        reference.child(firebaseUser.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        ...
                        if (user != null) {
                            try {
                                Glide.with(GroupChatRelayCommentActivity.this).load(user.getUser_imageurl())
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        ...
                        if (user != null) {
                            ...
                            try {
                                Glide.with(GroupChatRelayCommentActivity.this)
    ...
    private void addReplyComments() {
        ...
        if (!TextUtils.isEmpty(txt_replycomments)) {
            ...
            String idreply = reference.child(groupPostId)
                    .child(Constant.COLLECTION_POSTS)
                    .child(postid)
                    .child(Constant.COLLECTION_COMMENTS)
                    .child(commentid)
    ...
    private void getDataIntent() {
        ...
        groupPostId = intent.getStringExtra("groupPostId");
    ...
    private void addControls() {
        ...
        replyCommentAdapter = new GroupPostRelayCommentAdapter(GroupChatRelayCommentActivity.this, replyCommentList, postid, commentid, groupPostId);
