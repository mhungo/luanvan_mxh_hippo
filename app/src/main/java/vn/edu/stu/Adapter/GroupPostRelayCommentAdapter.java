...
public class GroupPostRelayCommentAdapter extends RecyclerView.Adapter<GroupPostRelayCommentAdapter.ViewHolder> {
    ...
    public GroupPostRelayCommentAdapter(Context context, List<ReplyComment> replyCommentList, String postid, String commentid, String groupPostId) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        return new GroupPostRelayCommentAdapter.ViewHolder(view);
    }
