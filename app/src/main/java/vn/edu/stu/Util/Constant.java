...
public class Constant {
    ...
    public static final String COLLECTION_FOLLOWER = "Follower";
    ...
    //variable
    public static final String VARIABLE_PROFILE_ID = "profileid";
    public static final String VARIABLE_PUBLISHER_ID = "publisherid";
    public static final String VARIABLE_POST_ID = "postid";
